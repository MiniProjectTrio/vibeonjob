      ...
      <main className="flex-1 relative z-10 flex items-center justify-center px-6 py-12">
        ...
        <div className="bg-surface/80 backdrop-blur-xl w-full max-w-[520px] rounded-[2.5rem] p-10 md:p-12 shadow-[0_32px_64px_-12px_rgba(0,33,80,0.08)] border border-white/50 flex flex-col items-center">
            ...
            <div className="text-center mb-8 w-full">
               <h1 className="font-headline text-3xl font-extrabold text-on-surface tracking-tight mb-3">Welcome back</h1>
            ...
            <form onSubmit={handleSubmit} className="w-full space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center ml-1">
                  <label className="text-[11px] font-extrabold uppercase tracking-widest text-on-surface-variant/80">Password</label>
                  <Link to="#" className="text-[11px] font-extrabold uppercase tracking-widest text-primary hover:text-secondary transition-colors">Forgot?</Link>
                </div>
                <div className="relative">
                  <input 
                    type="password"
            ...
            <div className="mt-10 text-center w-full">
                <p className="text-on-surface-variant font-medium text-sm">
                    ...
                    <Link to="/signup" className="text-primary font-bold ml-1 hover:underline underline-offset-8">Sign up for free</Link>
                </p>
            </div>
        </div>
      </main>
